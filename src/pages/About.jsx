...
<div className="card card-side bg-base-100 shadow-xl">
  ...
  <div className="card-body">
    ...
    <p>I am a Full-Stack Web Developer. I have knowledge of some back-end technology like mongo-db etc... and I have exsperiance with HTML5, CSS3, Vanilla JS, ExspressJs, NodeJs, ReactJs, many different libraries and frameworks. </p>
